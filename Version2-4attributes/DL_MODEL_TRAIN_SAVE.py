...
df1 = pandas.read_csv('DataSet4.csv')
...
history = modl.fit(x, Z,epochs=800,callbacks=callbacks)
modl.save_weights('DL_MODULE_4RMV2.weights.h5')

modl.load_weights('DL_MODULE_4RMV2.weights.h5')
