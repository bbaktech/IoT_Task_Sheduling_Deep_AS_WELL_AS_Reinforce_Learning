    ...
    def DelayFitness(self):
        ...
        for i in range(self.n_j ):
            ...
            if FR_ID == None:
                ...
                self.LatencyFitnes = self.LatencyFitnes + self.jbs[i].get_noInstructions() / g_cs.get_CPUSpeed() + LATENCY_CS_FR
    ...
    def CostFitness(self):
        ...
        for i in range(self.n_j ):
            ...
            if FR_ID == None:
                ...
                self.CostFitnes = self.CostFitnes + self.jbs[i].get_noInstructions() / g_cs.get_CPUSpeed() * CLOUD_COST_UNIT_TIME


#it returncs fog dev index in clusters list
    def getRs(self,j):
